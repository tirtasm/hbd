...
<head>
    ...
    <meta property="og:url" content="https://forzela.co" />
    <meta property="twitter:card" content="summary_large_image" />
    <link rel="canonical" href="https://forzela.co" />
    <link href="https://fonts.googleapis.com/css?display=swap&family=Inter:600,600italic%7CPoppins:800,800italic"
    ...
    <style>
        ...
        *:after {
        ...
        body:before {
            ...
            width: 100vw;
            z-index: 0;
            background-image: url('https://i.pinimg.com/564x/80/c3/29/80c329d8677cc8ec9126d4ae50bd19e4.jpg');
        ...
        #main {
            ...
            z-index: 1;
            background-color: #FFFFFF;
            box-shadow: 0rem 0rem 0.625rem 0rem rgba(0, 0, 0, 0.439);
        ...
        <div id="main">
            <div class="inner">
                <section id="home-section">
                    <p id="text03">zela is the most precious person</p>
                    <h1 id="text07">MY FAV GIRL</h1>
                    <p id="text02">zelaa, i love youu</p>
                    <div id="container01" class="container columns">
                        <div class="wrapper">
                            <div class="inner">
                                <div>
                                    <div id="image02" class="image"><a href="#one" class="frame"><img
                                                src="cute.jpg" alt="" /></a></div>
                                </div>
                                <div>
                                    <div id="image01" class="image"><a href="#two" class="frame"><img
                                                src="fix.jpg" alt="" /></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <p id="text05">I hope you know that you deserve it all. You're the most favorite person I have ever met, the most perfect person n the most amaaaaziinggg woman in the worlddd.</p>
                </section>
                <section id="one-section">
                    ...
                    <p id="text04">Hooray it&#039;s your birthday! Thank you for surviving in this world for 16 years,
                        that&#039;s very impressive. May you always be healthy, given a long life, and don&#039;t forget
                        to be happy! Well thank you for being my support system, you&#039;re the best human in this
                        world. Thank you for being born i really am happy to meet you here! I&#039;m thankful to the
                        God. And than thank you for surviving each days, you&#039;re strong!! I&#039;m soo proud of you!
                        Today it&#039;s all about you - have fun and enjoy in your special day! I love you so much my beautiful princess🤍🎀</p>
                    <div id="image03" class="image"><span class="frame"><img src="bagron coi"
                                alt="" /></span></div>
                    <div id="image04" class="image"><a
                            href="https://open.spotify.com/playlist/4RCS52B16OWIbLTjOqWneH?si=79ebbb553b414e18"
                            class="frame"><img
                                src="https://i.pinimg.com/564x/4e/13/a1/4e13a1cc0d76a268fd86b1b2839b99a7.jpg"
                                alt="" /></a></div>
                    <p id="text06">click me!</p>
                    <div id="image07" class="image"><span class="frame"><img src="bagron coi"
                                alt="" /></span></div>
                    <ul id="icons03" class="icons">
                        <li><a class="n01" href="#home" aria-label="Home"><svg>
                                    <use xlink:href="#icon-2a747dd19e728944f8c54ef1b55a59c6"></use>
                                </svg><span class="label">Home</span></a></li>
                    </ul>
                </section>
                <section id="two-section">
                    <h3 id="text01">what's my favorite?!</h3>
                    <div id="gallery01" class="gallery">
                        <div class="inner">
                            <ul>
                                <li><a href="#two" class="thumbnail"><span class="frame"><img
                                                src="https://i.pinimg.com/236x/1f/8d/00/1f8d00eeedd02808a70dbda591cfd55d.jpg"
                                                alt="Untitled" /></span></a></li>
                                <li><a href="#three" class="thumbnail"><span class="frame"><img src="YOU.png" width="1200" height="1000" 
                                                alt="Untitled" /></span></a></li>
                                <li><a href="#two" class="thumbnail"><span class="frame"><img
                                                src="https://i.pinimg.com/236x/dd/0b/39/dd0b39dcf95e3ad36e152194d3e237d1.jpg"
                                                alt="Untitled" /></span></a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <section id="three-section">
                    ...
                    <ul id="icons01" class="icons">
                        <li><a class="n01" href="#four" aria-label="Heart"><svg>
                                    <use xlink:href="#icon-0fab58c8cba7ae847fa5ba32ea5a4bea"></use>
                                </svg><span class="label">Heart</span></a></li>
                    </ul>
                </section>
                <section id="four-section">
                    <p id="text10">i just wanted to write you a cute paragraph for you. first of all i just wanna tell you how grateful i am for you & all the things that you do for me i know you don't think you do a lot but trust me, you do babeee. thank you for always making me smile & laught and thank you for helping me through rough patches ๑-﹏-๑ ! you're such a kind and loving person and in so glad i met you cause tbh you're one of a kind. i love you soooooo much and i hope you have an amazing activity even though it must be very tiring, but don't worry abt it ໒꒱ you'll be a okay . ⊹˚ you're an amazing person, always remember that ૮ ˶ˆ꒳ˆ˵ ა 🤍!</p>
                    <div id="image06" class="image"><a href="#two" class="frame deferred"><img src="z.png"
                                data-src="tengah.png" alt="" /></a></div>
                    <p id="text09"><span class="p">☽ . ✧ let me bring this cutie reminder for youu!!
                            (๑˃ᴗ˂)</span><span class="p">♡. ONEE. you're perfect just the way you are. please remember that I will always love you no matter what. I will always be by your side.</span><span class="p">♡. SECOND. if you feel tired of anything,
                            please take a rest. don&#039;t push yourself. you have your own limit and you couldn&#039;t
                            broke that limit. kalau capek, istirahat ya? tapi jangan lupa bangkit dan berjuang
                            lagii!!</span><span class="p">♡. THIRD. you did all your best everyday. I'm so proud of you. please focus on yourself and be the best version of yourself!! km hebat dengan semua yang sudah km lakuin. keep it up,
                            bb!!</span><span class="p">♡. LAST BUT NOT LEAST. please take care of yourself. jangan
                            sampe kamu terlalu sibuk buat jagain orang lain yaa? mbok km malah diambil orang lain (☍﹏⁰)｡. ok, bye. i lovee you sooo sooonicee&lt;3333</span></p>
